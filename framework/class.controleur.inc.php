...
abstract class controleur {
	...
	/**
	 * @param string $fachier : le fichier que l'on veux ajouter
	 * @var object $Dossier : le dossier css
	 * 
	 */
	/*public function getEnteteLine($fichier){
	    $Dossier = opendir("./css");
	    if  file_exists($fichier){
	        echo "link rel='stylesheet' type='text/css' href='./css/' ". $fichier ." '.css' />";
	        $Dossier = closedir("./css");
	    }else {
	        $Dossier = opendir("./framework/css");
	        if file_exists($fichier){
	            echo "link rel='stylesheet' type='text/css' href='./framwork/css/' ". $fichier ." '.css' />";
	            $Dossier = closedir(".framwork/css");
	        }else {
	            $Dossier = opendir("./librairie/jquery/css");
	            if file_exists($fichier){
	                echo "link rel='stylesheet' type='text/css' href='./librairie/jquery/css/' ". $fichier ." '.css' />";
	                $Dossier = closedir("./librairie/jquery/css");
	            }
