<?php
/*======= C O N T R O L E U R ====================================================================================
	fichier				: ./mvc/controleur/veilles/juridique.inc.php
	auteur				: Nathan Thomsset (nathan.thomasset2@gmail.com)
	date de création	: fevrier 2020
	date de modification:
	rôle				: le contrôleur de la page de veilles juridique
  ================================================================================================================*/
 ...
 */
class controleurVeillesJuridique extends controleur {

    private $modele;
    
    public function __construct(){
        require ("./mvc/modele/veilles/Juridique.inc.php");
        $this->modele = new modeleVeillesJuridique();
    }
